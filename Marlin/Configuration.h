...
#define CUSTOM_MENDEL_NAME "Back In Black"
...
//from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to 79.2, aggressive factor of .15 (vs .1, 1, 10)
    #define  DEFAULT_bedKp 262.34
    #define  DEFAULT_bedKi 21.41
    #define  DEFAULT_bedKd 803.76
...
//    You must specify the X & Y coordinates of all 3 points
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -1.05 // higher = close
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {79.6681,79.3590,3931.1559,483.817} //mk7 278.666
